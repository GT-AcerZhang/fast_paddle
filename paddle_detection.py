...
target_im_size = [608,448,448]

class Yolov3Detection():
    def __init__(self, layer_id):
        self.layer_id = layer_id
        self.target_size = target_im_size[self.layer_id-1]
        parser = argparse.ArgumentParser(description=__doc__)
        parser.add_argument(
            "--model_dir",
            type=str,
            default='inference_models/zzj_'+str(layer_id)+'/',
            help=("Directory include:'__model__', '__params__', "
                  "'infer_cfg.yml', created by tools/export_model.py."))
        parser.add_argument(
            "--image_file", type=str, default='', help="Path of image file.")
        parser.add_argument(
            "--video_file", type=str, default='/home/zzj/work1/20200506_170555.mp4', help="Path of video file.")
        parser.add_argument(
            "--run_mode",
            type=str,
            default='fluid',
        ...
        parser.add_argument(
            "--use_gpu", default=True, help="Whether to predict with GPU.")
        parser.add_argument(
        ...
        self.detector = Detector(
            self.FLAGS.model_dir, use_gpu=self.FLAGS.use_gpu, run_mode=self.FLAGS.run_mode)

    def single_image_detect(self, im):
        results = self.detector.predict(im, self.FLAGS.threshold)
        ...
        for box in np_boxes:
            ...
            cls_conf = box[5]
            cls_id = box[0]
            detection = [box[2], box[3], box[4], box[5], box[1], 1.0, box[0]]
...
if __name__ == '__main__':
    ...
    #video_path = '/home/zzj/work1/20200506_170555.mp4'
    yolov3 = Yolov3Detection(1)
    ...
    if cap.isOpened():
        while True:
            ...
            im = np.array(im)
            detect_dict = yolov3.single_image_detect(im)